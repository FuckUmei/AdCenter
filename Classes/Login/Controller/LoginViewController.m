...
-(void)setSubviews
{
    ...
    BGImg.backgroundColor = kBackgroundColor;
    ...
    [registBtn setTitleColor:kTitleColor(0x000000) forState:UIControlStateNormal];
    ...
    [loginBtn setTitleColor:kTitleColor(0xffffff) forState:UIControlStateNormal];
    ...
    if ([currentLanguage rangeOfString:@"en"].location != NSNotFound)
    {
        ...
        [attriTitle addAttribute:NSForegroundColorAttributeName value:kTitleColor(0x8d7300) range:(NSRange){0,TmpLab.text.length}];
    ...
    else if ([currentLanguage rangeOfString:@"zh"].location != NSNotFound)
    {
        ...
        [attriTitle addAttribute:NSForegroundColorAttributeName value:kTitleColor(0x8d7300) range:(NSRange){0,5}];
...
//         make.size.mas_equalTo(CGSizeMake(130, 15));
    ...
    [passWordFiled setValue: kTitleColor(0xb29300) forKeyPath:@"_placeholderLabel.textColor"];
    ...
    [acountFiled setValue: kTitleColor(0xb29300) forKeyPath:@"_placeholderLabel.textColor"];
    ...
    protocol.textColor = kTitleColor(0x6e5500);
    [protocol sizeToFit];
    ...
    [title addAttribute:NSForegroundColorAttributeName value:kTitleColor(0xf46404) range:titleRange];
    ...
    [title2 addAttribute:NSForegroundColorAttributeName value:kTitleColor(0x6e5500) range:titleRange];
    ...
    [seeStr addAttribute:NSUnderlineStyleAttributeName value:@1 range:rangge];
     [seeStr addAttribute:NSForegroundColorAttributeName value:kTitleColor(0x6e5500)  range:rangge];
    ...
    [seeStr2 addAttribute:NSForegroundColorAttributeName value:kTitleColor(0x8d7300) range:rangge];
